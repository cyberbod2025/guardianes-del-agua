...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    await delay(500);
    schoolLogo.classList.add('visible'); // Aparece y crece
    await delay(2500); // Se mantiene visible
    schoolLogo.classList.add('watermark'); // Inicia la animación a marca de agua
    await delay(2000);

    // 2. Secuencia de texto
